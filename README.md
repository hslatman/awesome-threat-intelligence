...
<table>
    ...
    <tr>
        <td>
            <a href="https://yazoul.net/" target="_blank">yazoul.net</a>
        </td>
        <td>
            Daily-updated security intelligence aggregator covering CVE advisories (CVSS ≥ 7.0, enriched with CISA KEV and EPSS), data breach reports, ransomware leak-site victim claims, malware family activity, correlated cybersecurity news, and long-form research. Each section publishes an RSS feed; a free newsletter is also available.
        </td>
    </tr>
